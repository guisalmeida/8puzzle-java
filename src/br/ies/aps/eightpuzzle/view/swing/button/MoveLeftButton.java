...
public class MoveLeftButton extends AbstractMoveButton {

	public MoveLeftButton(String direction, Board board, BoardView boardView,
								  ControlView controlView, Player player) {
	...
	public void updateBoardState() {
		this.getBoardController().moveLeft();
